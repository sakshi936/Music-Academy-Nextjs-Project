...
export const Menu = ({ setActive, children }: { setActive: (item: string | null) => void; children: React.ReactNode }) => {
	return (
		<nav
			...
			className="relative rounded-full boder border-transparent dark:bg-black/[0.7] dark:border-white/[0.2] bg-white shadow-input flex justify-center space-x-4 px-8 py-6 "
		>
			{children}
		</nav>
	);
